...
$(document).ready(function () {
   $(".cream_category a").click(function () {

      var category = $(this).attr("title"); 
      var count_all = $("#cream_item_all li").length; 
      var count = $("#cream_item_all li[class*=" + category + "]").length;
   
      $("#cream_item_all li").hide();

      if (category === "all") {
         $("#cream_item_all li").show();
         $('#item_count').val(count_all + '개의 상품이 있습니다.');

      } else {
         $("#cream_item_all li[class*=" + category + "]").show();
